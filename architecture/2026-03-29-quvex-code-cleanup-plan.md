...
**Files:**
- Modify: `C:\rynSoft\quvex\smallFactoryUI\.eslintrc.js`
- Modify: `C:\rynSoft\quvex\smallFactoryUI\package.json` (devDependencies)
...
**Files:**
- Modify: `C:\rynSoft\quvex\smallFactoryUI\vite.config.js`
...
**Files:**
- Modify: `C:\rynSoft\quvex\smallFactoryUI\src\setupTests.js`
...
```bash
mkdir -p /c/rynSoft/quvex/smallFactoryApi/src/Quvex.Application/Interfaces/Services
```
...
```bash
ls /c/rynSoft/quvex/smallFactoryApi/src/Quvex.API/Interfaces/
```
...
```bash
mkdir -p /c/rynSoft/quvex/smallFactoryApi/src/Quvex.Application/Services
```
