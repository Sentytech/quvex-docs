/**
 * Makine Imalati — Test tenant temizleme
...
// Her test koşumundan sonra buraya ID ekle (makine-tenant.json'dan bakarak)
const TEST_TENANT_IDS = [
  // Örnek: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', // makineXXXXXX tenant
]

base('Makine imalat test tenantlarini sil', async ({ page }) => {
