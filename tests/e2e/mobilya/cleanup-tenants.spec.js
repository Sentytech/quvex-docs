/**
 * Mobilya Imalati — Test tenant temizleme
...
// Her test koşumundan sonra buraya ID ekle (mobilya-tenant.json'dan bakarak)
const TEST_TENANT_IDS = [
  // Örnek: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', // mobilyaXXXXXX tenant
]

base('Mobilya imalat test tenantlarini sil', async ({ page }) => {
