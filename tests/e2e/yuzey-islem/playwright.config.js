...
module.exports = defineConfig({
  ...
  workers: 1,
  reporter: [
    ['html', { outputFolder: '../../../playwright-report/yuzey-islem' }],
    ['list'],
  ],
  timeout: 90_000,
  use: {
  ...
  projects: [
    ...
    { name: 'yuzey-islem', use: { browserName: 'chromium' }, dependencies: ['auth-setup'], testMatch: /yuzey-islem-data-entry-e2e\.spec\.js/ },
