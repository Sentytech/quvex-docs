/**
 * Yuzey Islem Kaplama — Test tenant temizleme
...
// Her test koşumundan sonra buraya ID ekle (yuzey-tenant.json'dan bakarak)
const TEST_TENANT_IDS = [
  // Örnek: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', // yuzeyislemXXXXXX tenant
]

base('Yuzey islem kaplama test tenantlarini sil', async ({ page }) => {
