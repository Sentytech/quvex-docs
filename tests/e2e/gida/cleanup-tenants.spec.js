/**
 * Gida Uretimi — Test tenant temizleme
...
// Her test koşumundan sonra buraya ID ekle (gida-tenant.json'dan bakarak)
const TEST_TENANT_IDS = [
  // Örnek: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', // gidaXXXXXX tenant
]

base('Gida uretimi test tenantlarini sil', async ({ page }) => {
