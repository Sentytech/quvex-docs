/**
 * Tekstil Üretimi — Test tenant temizleme
...
// Her test koşumundan sonra buraya ID ekle (tekstil-tenant.json'dan bakarak)
const TEST_TENANT_IDS = [
  // Örnek: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', // tekstilXXXXXX tenant
]

base('Tekstil uretimi test tenantlarini sil', async ({ page }) => {
