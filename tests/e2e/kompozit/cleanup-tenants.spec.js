/**
 * Kompozit İmalat — Test tenant temizleme
...
// Her test koşumundan sonra buraya ID ekle (kompozit-tenant.json'dan bakarak)
const TEST_TENANT_IDS = [
  // Örnek: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', // kompozitXXXXXX tenant
]

base('Kompozit imalat test tenantlarini sil', async ({ page }) => {
