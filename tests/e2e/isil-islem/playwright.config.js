...
module.exports = defineConfig({
  ...
  workers: 1,
  reporter: [
    ['html', { outputFolder: '../../../playwright-report/isil-islem' }],
    ['list'],
  ],
  timeout: 90_000,
  use: {
  ...
  projects: [
    ...
    { name: 'isil-islem', use: { browserName: 'chromium' }, dependencies: ['auth-setup'], testMatch: /isil-islem-data-entry-e2e\.spec\.js/ },
