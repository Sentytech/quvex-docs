/**
 * Isil Islem Fason — Test tenant temizleme
...
// Her test kosumundan sonra buraya ID ekle (isil-tenant.json'dan bakarak)
const TEST_TENANT_IDS = [
  // Ornek: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', // isilislemXXXXXX tenant
]

base('Isil islem test tenantlarini sil', async ({ page }) => {
