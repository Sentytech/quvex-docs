/**
 * Plastik Enjeksiyon — Test tenant temizleme
...
// Her test koşumundan sonra buraya ID ekle (plastik-tenant.json'dan bakarak)
const TEST_TENANT_IDS = [
  // Örnek: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', // plastikXXXXXX tenant
]

base('Plastik enjeksiyon test tenantlarini sil', async ({ page }) => {
