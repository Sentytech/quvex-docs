/**
 * Talaşlı İmalat — Test tenant temizleme
...
// Her test koşumundan sonra buraya ID ekle (talasli-tenant.json'dan bakarak)
const TEST_TENANT_IDS = [
  // Örnek: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', // talasliXXXXXX tenant
]

base('Talasli imalat test tenantlarini sil', async ({ page }) => {
