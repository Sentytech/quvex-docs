/**
 * Kaynak Atolyesi — Test tenant temizleme
...
// Her test koşumundan sonra buraya ID ekle (kaynak-tenant.json'dan bakarak)
const TEST_TENANT_IDS = [
  // Örnek: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', // kaynakXXXXXX tenant
]

base('Kaynak atolyesi test tenantlarini sil', async ({ page }) => {
