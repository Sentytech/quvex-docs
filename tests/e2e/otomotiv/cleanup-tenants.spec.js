/**
 * Otomotiv Yan Sanayi — Test tenant temizleme
...
// Her test koşumundan sonra buraya ID ekle (otomotiv-tenant.json'dan bakarak)
const TEST_TENANT_IDS = [
  // Örnek: 'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx', // otomotivXXXXXX tenant
]

base('Otomotiv test tenantlarini sil', async ({ page }) => {
