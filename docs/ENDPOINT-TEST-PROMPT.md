...
3. Eger kapaliysa:
   - API: cd /c/rynSoft/smallFactoryApi/src/Quvex.API && nohup dotnet run --no-build > /dev/null 2>&1 &
   - UI: cd /c/rynSoft/smallFactoryUI && nohup npx vite --port 3000 > /dev/null 2>&1 &
4. Playwright endpoint testini calistir:
   cd /c/rynSoft/smallFactoryUI && npx playwright test e2e/api-endpoint-health.spec.js --project=setup --project=chromium --grep "Full endpoint summary" --retries=0
...
8. docs/API-UI-ENDPOINT-MAP.md dosyasini guncelle

Test dosyasi: e2e/api-endpoint-health.spec.js
Endpoint haritasi: docs/API-UI-ENDPOINT-MAP.md
...
1. Yeni controller'in route'unu bul: grep -n "Http\|Route" /c/rynSoft/smallFactoryApi/src/Quvex.API/Controllers/YeniController.cs
2. UI'da hangi sayfadan cagrildigi bul: grep -r "YeniEndpoint" /c/rynSoft/smallFactoryUI/src/services/
...
5. docs/API-UI-ENDPOINT-MAP.md dosyasini guncelle
```
...
1. EF model'i kontrol et: cat /c/rynSoft/smallFactoryApi/src/Quvex.API/Models/YeniModel.cs
   veya: cat /c/rynSoft/smallFactoryApi/src/Quvex.Domain/Entities/.../YeniModel.cs
...
| Dosya | Konum |
|-------|-------|
| Endpoint test | `C:\rynSoft\smallFactoryUI\e2e\api-endpoint-health.spec.js` |
| Endpoint haritasi | `C:\rynSoft\smallFactoryUI\docs\API-UI-ENDPOINT-MAP.md` |
| Auth setup | `C:\rynSoft\smallFactoryUI\e2e\auth.setup.js` |
| Playwright config | `C:\rynSoft\smallFactoryUI\playwright.config.js` |
| API Controllers | `C:\rynSoft\smallFactoryApi\src\Quvex.API\Controllers\` |
| UI Services | `C:\rynSoft\smallFactoryUI\src\services\` |
| UI Routes | `C:\rynSoft\smallFactoryUI\src\router\routes\index.js` |
